...
<body <?php body_class(); ?>>
	<!--[if lte IE 8]>
	<p class="OldieMessage">Let op! U gebruikt Internet Explorer 8 of lager (een <strong>sterk verouderd</strong> internetprogramma) om deze website te bekijken. <br /> <a href="http://browsehappy.com/">Download gratis een snellere en veiligere versie</a> om deze website optimaal te ervaren.</p>
	<![endif]-->
